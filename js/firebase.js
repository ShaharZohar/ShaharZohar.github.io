...
// Blocks requests from any domain not on your reCAPTCHA allowlist.
// Enable enforcement in Firebase Console → App Check → Firestore → Enforce.
//
// During local development, uncomment the debug token line below,
// then add the printed token to Firebase Console → App Check → Apps → overflow menu → Manage debug tokens
//
// self.FIREBASE_APPCHECK_DEBUG_TOKEN = true; // ← uncomment for localhost only
